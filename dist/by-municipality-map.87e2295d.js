...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/by-municipality-map.js":[function(require,module,exports) {
...
window.onload = function () {
  getJSON(DATAFILES.BYMUNICIPALITY, function (err, dataJson) {
    if (err != null) {
      ...
      function getColor(d) {
        return d > 10000 ? '#800026' : d > 8000 ? '#BD0026' : d > 7000 ? '#E31A1C' : d > 6000 ? '#FC4E2A' : d > 5000 ? '#FD8D3C' : d > 4000 ? '#FEB24C' : d > 2000 ? '#FED976' : d > 0 ? '#FFEDA0' : 'white';
      }
      ...
      L.tileLayer('https://{s}.tile.openstreetmap.de/tiles/osmde/{z}/{x}/{y}.png', {
        maxZoom: 18,
        attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(map2); //let geojson_url2 = "./maps/municipios_latlon.json";

      function getColor2(d) {
        return d > 8 ? '#800026' : d > 6 ? '#BD0026' : d > 4 ? '#E31A1C' : d > 3 ? '#FC4E2A' : d > 2 ? '#FD8D3C' : d > 1 ? '#FEB24C' : d > 0.5 ? '#FED976' : d > 0 ? '#FFEDA0' : '#f6efd0';
      }
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/by-municipality-map.js"], null)
//# sourceMappingURL=/by-municipality-map.87e2295d.js.map