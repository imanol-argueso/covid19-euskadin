...
},{"./getData.js":"../js/getData.js"}],"../js/index-covid.js":[function(require,module,exports) {
"use strict";
...
window.onload = function () {
  (0, _getData.getJSON)(_config.DATAFILES.EPIDEMICSTATUS, function (err, dataJson) {
    if (err != null) {
      alert('Something went wrong: ' + err);
    } else {
      document.getElementById("tests").innerHTML = (0, _dashboard.dashboard)(dataJson, 'pcrTestCount');
      document.getElementById("testsRapidos").innerHTML = (0, _dashboard.dashboard)(dataJson, 'serologyTestCount');
      document.getElementById("personasUnicasPcr").innerHTML = (0, _dashboard.dashboard)(dataJson, 'pcrUniquePersonCount');
      document.getElementById("hospitalizaciones").innerHTML = (0, _dashboard.dashboard)(dataJson, 'newHospitalAdmissionsWithPCRCount');
      document.getElementById("hospitalizadosUci").innerHTML = (0, _dashboard.dashboard)(dataJson, 'icuPeopleCount');
      document.getElementById("altasHospitalarias").innerHTML = (0, _dashboard.dashboard)(dataJson, 'hospitalReleasedCount');
      document.getElementById("positivos").innerHTML = (0, _dashboard.dashboard)(dataJson, 'totalPositiveCount');
      ...
      document.getElementById("fallecidos").innerHTML = (0, _dashboard.dashboard)(dataJson, 'deceasedCount');
      ...
      document.getElementById("r0").innerHTML = (0, _dashboard.dashboard)(dataJson, 'r0');
...
},{"./config":"../js/config.js","./getData.js":"../js/getData.js","./dashboard.js":"../js/dashboard.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../js/index-covid.js"], null)
//# sourceMappingURL=/index-covid.4959b879.js.map