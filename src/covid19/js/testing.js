        ...
        if (err != null) {
            ...
            function drawChart() {
                ...
                if (window.location.href.indexOf("/eu/") > -1) {
                    ...
                    data.addColumn('number', 'Testak guztira');
                    /*
                    ...
                    */
                    var options = {
                        chart: {
                            ...
                            subtitle: 'Euskadin egindako testak guztira (PCR eta antigeno probak).',
                        },
                        width: 900,
                        height: 500
                    };
                    ...
                    data.addColumn('number', 'Test totales');
                    /*
                    ...
                    */
                    var options = {
                        chart: {
                            ...
                            subtitle: 'Test totales (PCR y antígeno) realizados en Euskadi.',
                        },
                        width: 900,
                        height: 500
                    };
            ...
            function drawTable() {
                ...
                if (window.location.href.indexOf("/eu/") > -1) {
                    ...
                    data.addColumn('number', 'Testak guztira');
                    data.addColumn('number', 'Test azkarrak guztira');
                    data.addColumn('number', ' Pertsona bakarrak guztira');
                    ...
                    data.addColumn('number', 'Test totales');
                    data.addColumn('number', ' Test rápidos totales');
                    data.addColumn('number', ' Personas únicas totales');
                    var monthYearFormatter = new google.visualization.DateFormat({
                        pattern: "dd-MM-yyy"
                    });
                }
